...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript" data-cfasync="false" src="{$template_dir}hbchat/media/jquery.js?v={$hb_version}"></script>
        <script type="text/javascript" data-cfasync="false" src="{$template_dir}hbchat/media/mustache.js?v={$hb_version}"></script>
        <script type="text/javascript" data-cfasync="false" src="{$template_dir}hbchat/media/popup.js?v={$hb_version}v"></script>
        <script type="text/javascript" data-cfasync="false" src="{$template_dir}hbchat/media/jquery.simplemodal.js?v={$hb_version}"></script>
        <script type="text/javascript" data-cfasync="false" src="{$template_dir}hbchat/media/osx.js?v={$hb_version}"></script>
        <script type="text/javascript" data-cfasync="false" src="{$template_dir}hbchat/media/soundmanager2-nodebug-jsmin.js?v={$hb_version}v"></script>
        <script type="text/javascript" data-cfasync="false" src="{$template_dir}hbchat/media/jquery.jgrowl_minimized.js?v={$hb_version}"></script>
        ...
        $(document).ready(function() {
            ...
            HBOperator.sound_visitorchange =  "templates/default/hbchat/media/visitor.mp3";
    ...
    <body class="hbpopup">
        ...
        <div id="hb_chat_tabs_container">
            <div class="chat_tab chat_tab_active" onclick="HBOperator.switch_tab('visitors', this);">
                <span class="tab_txt">Live traffic</span><span id="visitors_count" class="tab_counter">0</span>
            </div>
        ...
        <div id="hb_chat_status_bar" style="position:fixed;bottom:29px; right:15px; width: 368px;">
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td>Status: 
                        <input type="radio" name="current_status" value="Active" checked="checked" id="status_active"
                               onclick="return HBOperator.change_status('Active');" />online
                        <input type="radio" name="current_status" value="Away" id="status_away"
                               onclick="return HBOperator.change_status('Away');" />away
                        <input type="radio" name="current_status" value="Offline" id="status_offline"
                               onclick="return HBOperator.change_status('Offline');" />offline
                    </td>
                    <td width="90">chats today: <br/>
                        <span class="fs10">
                            <span id="chats_today_cnt">0</span> accepted
                        </span>
                    </td>
                </tr>
            </table>
        ...
        <div id="osx-modal-content" style="display:none">
         ...
         {* BOF: SOUND.JS *}
        <div id="sound_visitorchange"></div>
        <div id="sound_newchat"></div>
