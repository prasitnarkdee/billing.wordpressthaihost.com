    ...
    <form action="" method="post" >
        ...
        <table cellspacing="0" cellpadding="6" >
            <tbody class="sectioncontent">
                 ...
                 {if $brands}
                     <tr>
                         <td align="right" width="180"><strong>Brand <a class="vtip_description " title="Choose a brand from the Multibrand plugin for which widget are to be generated"></a></strong></td>
                         <td class="editor-container" colspan="2">
                             <select class="inp" name="url">
                ...
                {if $tag == 'sidebar'}
                    <tr>
                        <td align="right" width="180"><strong>Position <a class="vtip_description " title="Choose the position where the widget should be"></a></strong></td>
                        <td class="editor-container" colspan="2">
