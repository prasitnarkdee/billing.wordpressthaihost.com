...
<form method="POST">
    ...
    <div class="lighterblue2">
        <div class="row">
                ...
                <table border="0" cellpadding="6" cellspacing="0" width="100%">
                                ...
                                <div class="col-12 col-md-6 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="margin: 2px 0;" >
                                            <div class="input-group-addon default_margin_type_char" data-char="Percent" style="display: none;">%</div>
                                            <div class="input-group-addon default_margin_type_char" data-char="Fixed" style="display: none;">{$currency.sign}</div>
                                            <input type="text" name="default_margin_renewal" class="form-control" placeholder="0.00" value="{$profile.default_margin_renewal}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="margin: 2px 0;" >
                                            <div class="input-group-addon default_margin_type_char" data-char="Percent" style="display: none;">%</div>
                                            <div class="input-group-addon default_margin_type_char" data-char="Fixed" style="display: none;">{$currency.sign}</div>
                                            <input type="text" name="default_margin_transfer" class="form-control" placeholder="0.00" value="{$profile.default_margin_transfer}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-6 col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="margin: 2px 0;" >
                                            <div class="input-group-addon default_margin_type_char" data-char="Percent" style="display: none;">%</div>
                                            <div class="input-group-addon default_margin_type_char" data-char="Fixed" style="display: none;">{$currency.sign}</div>
                                            <input type="text" name="default_margin_redemption" class="form-control" placeholder="0.00" value="{$profile.default_margin_redemption}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <tr class="support_import_tld">
                        <td width="200" align="right">
                            ...
                            <a href="#" class="vtip_description" title='Use CRON to periodically pull price changes and update related TLDs automatically'></a>
                        </td>
                        <td>
                    ...
                    <tr class="support_import_tld">
                        <td width="200" align="right">
                            <strong>Fill missing TLDs</strong>
                            <a href="#" class="vtip_description" title='When selected all new tlds that are not in your offer will be imported from App. Default product will be used as template for imported TLD.'></a>
                        </td>
                        <td>
                            <div class="checkbox" style="margin-left: 20px;">
                    ...
                    <tr class="support_import_tld">
                        <td width="200" align="right">
                            ...
                            <a href="#" class="vtip_description" title='If registry does not return periods you currently offer, its prices will be auto-udpated based on minimal period. I.e.: if you offer 2 year TLD registration, and registry API returns only 1 year pricing, 2 year price will be set based on 1 year, multiplied by actual period (2).'></a>
                        </td>
                        <td>
                            <div class="checkbox" style="margin-left: 20px;">
            ...
            <div class="col-md-12">
                {if $profile.id}
                    <div id="tld_profile_settings" class="support_import_tld">
                        <center>
                        ...
                        <script type="text/javascript">
                            $(function () {
                                ajax_update("?cmd=importaccounts&action=tld_profile_settings&id={/literal}{$profile.id}{literal}",{},'#tld_profile_settings');
                            })
                        </script>
                        {/literal}
                    </div>
