...
(function (factory) {
    ...
    Plugin.prototype = {
        ...
        _generateMarkup: function () {
            ...
            this.countryCodeInputHidden = $("#" + this.countryInput.attr("id") + "_hidden");
        ...
        _initListeners: function () {
            ...
            var selectedFlag = this.selectedFlagInner.parent().parent();
            ...
            if (value) {
                ...
                for (var i = 0; i < this.countries.length; i++) {
                    if (this.countries[i].iso2.match(matcher)) {
                        countryCode = this.countries[i].iso2;
        ...
        _selectFlag: function (countryCode) {
            ...
            this.countryInput.val(countryData.name);
            this.countryCodeInput.val(countryData.name);
            this.countryCodeInputHidden.val(countryData.iso2);
