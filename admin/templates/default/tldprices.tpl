	...
	{if $action=='edit' && $tld}
				...
				{/foreach}</select>
                                ...
                                {foreach item=i from=0|@range:9}
                                    <tr>
                                        <td><strong>{$lang.Nameserver} {$i+1}</strong></td>
                                        <td>
                                            <input class="inp" value="{$tld.ns[$i]}"  name='ns[{$i}]'/>
                                        </td>
                                    </tr>
                                {/foreach}
                                </tbody>
			 		...
			 		{if $tld.nsip|is_array} <tbody  >
                                ...
                                {foreach item=i from=0|@range:9}
                                    <tr>
                                        <td><strong>{$lang.Nameserver} IP {$i+1}</strong></td>
                                        <td>
                                            <input class="inp" value="{$tld.nsip[$i]}"  name='nsip[{$i}]'/>
                                        </td>
                                    </tr>
                                {/foreach}
                                </tbody>
