                            ...
                            <tr>
                                ...
                                <td valign="top" align="right">
                                    <div style="padding:5px 0px;">
                                        <a style="width:12px;height:14px;display:block; box-sizing: content-box;" href="#" class="menuitm" title="delete" onclick="$('#condition_field_new_val').val(0);$('#conditional_{$k}').remove();saveChangesField(); return false">
