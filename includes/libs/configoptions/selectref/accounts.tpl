...
{if $cmd != 'orders' && $make != 'getproduct'}
x {$c.qty}
{/if}
{if $cfitem_description}
<span style="display:block;color: #777;margin-bottom: 5px;"
      class="text-secondary cf_item_description_value cf_{$c.copy_of}_item_description_value">
    {$cfitem_description|escape}
</span>
{/if}
