 ...
 */
   ...
   /**
        ...
        if ($params['resource_type'] == 'file') {
            ...
            if (!preg_match('/^([\/\\\\]|[a-zA-Z]:[\/\\\\])/', $params['resource_name'])) {
                ...
                foreach ((array)$params['resource_base_path'] as $_curr_path) {
                    $_fullpath = $this->_absolute_path($params['resource_name'], $_curr_path);
                ...
                /* absolute path */
                $params['resource_name'] = $this->_absolute_path($params['resource_name']);
     ...
     * @return string
     */
    function _absolute_path($path, $basedir = false) {
        $parts = array();// Array to build a new path from the good parts
        $path = str_replace('\\/', DIRECTORY_SEPARATOR, $path);
        if ($path[0] != DIRECTORY_SEPARATOR)
            $path = ($basedir ?: getcwd()) . DIRECTORY_SEPARATOR . $path;
