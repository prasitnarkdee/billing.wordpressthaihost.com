...
//                                       , $source_content);
    ...
    function _compile_include_tag($tag_args)
    {
        ...
        $tpl_config = $this->get_template_vars('tpl_config');
        if (!empty($tpl_config)) {
            $include_file_new = HBEventManager::notify('before_smartyinclude', $include_file);
            if ($include_file_new[0] && is_string($include_file_new[0])) {
                $include_file = $include_file_new[0];
            }
        }
