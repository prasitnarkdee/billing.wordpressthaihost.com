...
var generatedcartlink = function() {
    $('#resultbar').html('<img src="ajax-loading.gif" alt="" />');
    $.get('?cmd=module&module=directcartlinks&do=generatelink',{},function(r){

        $('#resultbar').html(r);
    });
    return false;
};
var fndirect=function() {
    $('body').append('<div id="jixedbar">'
        +'<ul><li title="Dump current cart contents into re-usable link"><a href="#" id="generate_link" onclick="return generatedcartlink();">Generate direct link</a></li></ul>'
        + '<span class="jx-separator-left"></span>'
        +'<div class="text-container" id="resultbar"></div><span class="jx-separator-right"></span></div>');

    $('#jixedbar').jixedbar();


};
$(document).ready(fndirect);
