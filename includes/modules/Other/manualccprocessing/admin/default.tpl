                ...
                <tr class="{if $inv.status=='Processed'} compor {/if}">
                    ...
                    <td>
                        {if $inv.status=='Unpaid' && $inv.state=='Pending' }
                            <a href="?cmd=module&module={$moduleid}&action=process&id={$inv.id}" class="new_control greenbtn">
                                {$lang.Process}
                            </a>
                        {else}
                            <a href="?cmd=module&module={$moduleid}&action=process&id={$inv.id}" class="menuitm">
                                {$lang.showdetails}
                            </a>
                        {/if}
                        {if $inv.state!='Processed'}
                            <a href="?cmd=module&module={$moduleid}&action=delete&id={$inv.id}" class="menuitm">
                                {$lang.Delete}
                            </a>
                        {/if}
                    </td>
