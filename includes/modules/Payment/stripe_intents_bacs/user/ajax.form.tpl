<link href="{$base_url}includes/modules/Payment/stripe_intents_bacs/user/styles.css" rel="stylesheet" type="text/css" />
<div class="wrapper stripe-box">
    ...
    <form action="?cmd=stripe_intents_bacs&action=pay&do=new" method="post" id="payment-form" target="_top">
