...
<div class="wbox">
    <div class="wbox_header">
        <strong class="pull-left">{$lang.ordersummary}</strong>
        <div class="pull-right">
            ...
            <a href="?cmd=cart&clear=true&step=4" class="btn" style="margin: 0;">
                {$lang.clear_cart}
            </a>
        </div>
            ...
            {if $contents}
                {foreach from=$contents item=order key=k}
                    <tbody>
                            ...
                            <tr class="srow">
                                <td valign="top">
                                    ...
                                    {if $order.product.period}
                                        <small style="margin: 0 5px; font-size: 90%; color: #888">
                                            {$order.product.period.from|dateformat:$date_format} -
                                            {$order.product.period.to|dateformat:$date_format}
                                        </small>
                                    {/if}
                                </td>
                                <td>
                        ...
                        <tr>
                            <td colspan="3">
                                {if $order.product || $order.subproducts}
...
<form action="{$ca_url}cart" method="post">
    ...
    <div class="orderbox"  id="checkout">
        <div class="orderboxpadding">
            <center>
                <a href="{if $parent_account}?cmd=cart&cat_id=addons&account_id={$parent_account.id}{else}?cmd=products{/if}" class="padded btn">{$lang.continue_shopping|default:"Continue shopping"}</a>
