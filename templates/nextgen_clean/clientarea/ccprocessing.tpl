    ...
    {if $allow_partial}
        <div class="wbox">
            <div class="wbox_header">
                <strong>{$lang.partialpayment}:</strong>
            </div>
            <div class="wbox_content" id="ccpcontent">
                <table width="100%" cellpadding="0" cellspacing="0" class="table table-striped">
                    <tr>
                        <td colspan="2" class="even">
                            <input type="radio" name="custom_amount" value="0" checked="checked"
                                   onclick="$('#partialpayment').hide();"/>
                            {$lang.payfulldueamount|default:"Pay full due amount"}
                        </td>
                    </tr>
                    <tr class="even">
                        <td colspan="2">
                            <input type="radio" name="custom_amount" value="1" onclick="$('#partialpayment').show();"/>
                            {$lang.specifyamounttopay|default:"Specify amount to pay (partial payment)"}
                        </td>
                    </tr>
                    <tr id="partialpayment" style="display: none">
                        <td align="right" width="160">
                            <div class="input-group">
                                <input type="text" value="{$invoice_total}" size="4" name="custom_amount_value"
                                       class="form-control"/>
                            </div>
